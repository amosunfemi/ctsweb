...
(function () {
    ...
    (function () {
        ...
        CKEDITOR.tools = {arrayCompare: function (b, a) {
            ...
            for (var b = [].concat(b), a, e = [], d = 0; d < b.length; d++)if (a = b[d])/
            @
            import|
            [
                {}
