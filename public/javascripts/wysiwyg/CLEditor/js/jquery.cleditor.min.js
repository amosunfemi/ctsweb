...
(function (e) {
    function aa(a) {
        ...
        if (!(b.disabled || e(c).attr(n) == n)) {
            ...
            if (d == "source") {
                ...
                "print")b.$frame[0].contentWindow.print(); else if (!v(b, g.command, g.value, g.useCSS, c))return false;
            w(b)
        }
    }
    ...
    function ba(a) {
        ...
        if (!(b === p.msg || e(b).hasClass(B))) {
            ...
            if (h == "font")g = c.style.fontFamily.replace(/"/g, ""); else if (h == "size") {
                if (c.tagName == "DIV")c = c.children[0];
                g = c.innerHTML
            } else if (h == "style")g = "<" + c.tagName + ">"; else if (h == "color")g = Q(c.style.backgroundColor); else if (h == "highlight") {
                g = Q(c.style.backgroundColor);
                if (l)i = "backcolor"; else j = true
            }
    ...
    function R(a, b, c, d, h) {
        ...
        }); else if (a == "style")e.each(b.styles, function (i, g) {
    ...
    function T(a, b) {
        ...
        try {
            if (l)a.doc.body.contentEditable = !b; else a.doc.designMode = !b ? "on" : "off"
        } catch (c) {
        }
        u(a)
    }
    ...
    function v(a, b, c, d, h) {
        ...
        d = true;
        var f;
        if (l && b.toLowerCase() == "inserthtml")y(a).pasteHTML(c); else {
            try {
    ...
    function K(a) {
        ...
        if (l) {
            i.bind("beforedeactivate beforeactivate selectionchange keypress", function (g) {
                if (g.type == "beforedeactivate")a.inactive = true; else if (g.type == "beforeactivate") {
        ...
        (e.support.mozilla ? i : e(h)).blur(function () {
            V(a, true)
        });
    ...
    function u(a) {
        ...
        e.each(a.$toolbar.find("." + W), function (d, h) {
            ...
            if (a.disabled)j = false; else if (i.getEnabled) {
    ...
    var H = "backgroundColor", A = "button", x = "buttonName", F = "change", Y = "cleditor", q = "click", n = "disabled", m = "<div>", I = "unselectable", W = "cleditorButton", X = "cleditorDisabled", ca = "cleditorPopup", S = "cleditorList", da = "cleditorColor", B = "cleditorPrompt", fa = "cleditorMsg", l = e.support.msie, ea = /msie\s6/i.test(navigator.userAgent),
    ...
    cleditor = function (a, b) {
        ...
        e.each(b.controls.split(" "), function (g, j) {
            ...
            if (j == "|") {
                ...
                if (k.css)G = k.css; else if (k.image)G.backgroundImage = "url(" + U() + k.image + ")";
